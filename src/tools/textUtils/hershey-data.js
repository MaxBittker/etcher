// p5.hershey.data.js
// standard hershey font ported to js code
var FONT_HERSHEY = {}
FONT_HERSHEY.SIMPLEX = function(x) {
  return [
...
FONT_HERSHEY.SCRIPT_SIMPLEX = function(x) {
  return [
...
FONT_HERSHEY.GOTHIC_ENGLISH_TRIPLEX = function(x) {
  return [
...
FONT_HERSHEY.GOTHIC_GERMAN_TRIPLEX = function(x) {
  return [
    3699, 3714, 3728, 2275, 3719, 2271, 3718, 3717, 3721, 3722,
    3723, 3725, 3711, 3724, 3710, 3720, 3700, 3701, 3702, 3703,
    3704, 3705, 3706, 3707, 3708, 3709, 3712, 3713, 2241, 3726,
...
FONT_HERSHEY.GOTHIC_ITALIAN_TRIPLEX = function(x) {
  return [
    3699, 3714, 3728, 2275, 3719, 2271, 3718, 3717, 3721, 3722,
    3723, 3725, 3711, 3724, 3710, 3720, 3700, 3701, 3702, 3703,
    3704, 3705, 3706, 3707, 3708, 3709, 3712, 3713, 2241, 3726,
...
FONT_HERSHEY.GREEK_COMPLEX = function(x) {
  return [
...
FONT_HERSHEY.GREEK_COMPLEX_SMALL = function(x) {
  return [
...
FONT_HERSHEY.GREEK_PLAIN = function(x) {
  return [
...
FONT_HERSHEY.GREEK_SIMPLEX = function(x) {
  return [
    699, 714, 717, 733, 719, 2271, 734, 731, 721, 722,
    2219, 725, 711, 724, 710, 720, 700, 701, 702, 703,
    704, 705, 706, 707, 708, 709, 712, 713, 2241, 726,
...
FONT_HERSHEY.CYRILLIC_COMPLEX = function(x) {
  return [
    2199, 2214, 2213, 2275, 2274, 2271, 2272, 2251, 2221, 2222,
    2219, 2232, 2211, 2231, 2210, 2220, 2200, 2201, 2202, 2203,
    2204, 2205, 2206, 2207, 2208, 2209, 2212, 2213, 2241, 2238,
...
FONT_HERSHEY.ITALIC_COMPLEX = function(x) {
  return [
...
FONT_HERSHEY.ITALIC_COMPLEX_SMALL = function(x) {
  return [
    1199, 1214, 1213, 1275, 1274, 1271, 1272, 1251, 1221, 1222,
...
FONT_HERSHEY.ITALIC_TRIPLEX = function(x) {
  return [
...
FONT_HERSHEY.SCRIPT_COMPLEX = function(x) {
  return [
    2749, 2764, 2778, 2275, 2769, 2271, 2768, 2767, 2771, 2772,
    2773, 2775, 2761, 2774, 2760, 2770, 2750, 2751, 2752, 2753,
    2754, 2755, 2756, 2757, 2758, 2759, 2762, 2763, 2241, 2776,
...
FONT_HERSHEY.COMPLEX = function(x) {
  return [
    2199, 2214, 2213, 2275, 2274, 2271, 2272, 2251, 2221, 2222,
    2219, 2232, 2211, 2231, 2210, 2220, 2200, 2201, 2202, 2203,
    2204, 2205, 2206, 2207, 2208, 2209, 2212, 2213, 2241, 2238,
...
FONT_HERSHEY.COMPLEX_SMALL = function(x) {
  return [
    1199, 1214, 1213, 1275, 1274, 1271, 1272, 1251, 1221, 1222,
    1219, 1232, 1211, 1231, 1210, 1220, 1200, 1201, 1202, 1203,
    1204, 1205, 1206, 1207, 1208, 1209, 1212, 1213, 1241, 1238,
...
FONT_HERSHEY.DUPLEX = function(x) {
  return [
...
FONT_HERSHEY.TRIPLEX = function(x) {
  return [
